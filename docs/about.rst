...
and an MSc in Marketing (Syracuse University, as a Fulbright scholar and Beta
Gamma Sigma inductee).
...
An MSc in Marketing and years working as a marketing analyst and engineer,
documenting analytics for marketers who are not technical.

**Machine learning and data science.** Applied ML in Python (pandas,
scikit-learn); NLP and transformers (BERT, spaCy); retrieval-augmented
generation (LangChain, ChromaDB); and LLM and agent tooling (the Model Context
Protocol). An MSc in Data Science, and hands-on work building an LLM-to-data
...
engineers and specialists who know things they cannot always articulate.
...
what it really is: a documentation problem. Getting a model to produce consistent, accurate
output takes the same precision, structure and audience-awareness as getting a
product to produce consistent, accurate documentation.
